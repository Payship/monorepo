...
1. **Phase 0 – ILO:** 11,000 PSHP tokens are minted at the inception of Payship, with the following distribution:
  ...
  - 1,000 PSHP tokens are given away proportionally to the top 32 SwapShip (SWSH) holders based on a Oct 10, 2020 snapshot.
  - 4,000 PSHP tokens are offered in a 7 day presale starting Oct 12, 2020 with a starting price of 0.25 ETH per 1 PSHP.
